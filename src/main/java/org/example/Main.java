...
import org.example.infra.DefaultTranslator;
...
public class Main {
    public static void main(String[] args) {
        FizzBuzzService service = new FizzBuzzServiceImpl(new ScreenView(new DefaultTranslator()), new HardcodeInputRetriever());
        service.runService();
